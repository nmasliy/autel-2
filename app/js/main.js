...
/* harmony import */ var _components_player_and_modals__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/player-and-modals */ "./src/js/components/player-and-modals.js");
...
/* harmony import */ var _functions_menu__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../functions/menu */ "./src/js/functions/menu.js");
/* harmony import */ var _functions_menu__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_functions_menu__WEBPACK_IMPORTED_MODULE_2__);



(0,_functions_header_height__WEBPACK_IMPORTED_MODULE_0__.getHeaderHeight)();
let func = (0,_functions_throttle__WEBPACK_IMPORTED_MODULE_1__.throttle)(_functions_header_height__WEBPACK_IMPORTED_MODULE_0__.getHeaderHeight);
window.addEventListener('resize', func);

/***/ }),

/***/ "./src/js/components/player-and-modals.js":
/*!************************************************!*\
  !*** ./src/js/components/player-and-modals.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _functions_modals__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../functions/modals */ "./src/js/functions/modals.js");


const player = new (plyr__WEBPACK_IMPORTED_MODULE_0___default())('#player', {
...
const modals = new _functions_modals__WEBPACK_IMPORTED_MODULE_1__["default"](options);
modals.init();
...
const getHeaderHeight = () => {
  if (document.querySelector('.header__top')) {
    ...
    const headerHeight = (_document = document) === null || _document === void 0 ? void 0 : _document.querySelector('.header__top').offsetHeight;
...
(function () {
  var _document, _document2, _document3, _document4, _document5, _document6, _document7;

  const $html = document.querySelector('html');
  const $header = (_document = document) === null || _document === void 0 ? void 0 : _document.querySelector('.header');
  ...
  const $close = (_document4 = document) === null || _document4 === void 0 ? void 0 : _document4.querySelector('[data-menu-close]');
  const $overlay = (_document5 = document) === null || _document5 === void 0 ? void 0 : _document5.querySelector('[data-menu-overlay]');
  const $menuItems = (_document6 = document) === null || _document6 === void 0 ? void 0 : _document6.querySelectorAll('[data-menu-item]');
  const $submenuItems = (_document7 = document) === null || _document7 === void 0 ? void 0 : _document7.querySelectorAll('.nav__item--submenu > a');
